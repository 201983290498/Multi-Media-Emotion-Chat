...
public class AHelper extends Thread{
    ...
    public AHelper(LHelper lHelper) {
        this.lHelper = lHelper;
        int inputByteNum = lHelper.initAudioCodec(SAMPLE_RATE_HZ, channelCount);
        /*
    ...
    public void run() {
        ...
        while (isRecoding) {
            ...
            if (lHelper != null && len > 0) {
                lHelper.pushAudio(buffer);
            }
        }
