...
extern "C"
JNIEXPORT void JNICALL
Java_com_wish_videopath_Emotion_utils_LHelper_init(JNIEnv *env, jobject thiz) {
    videoChannel = new VideoChannel;
    videoChannel->setVideoCallBack(callBack);
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_wish_videopath_Emotion_utils_LHelper_setVideoEncInfo(JNIEnv *env, jobject thiz,
                                                                    jint width, jint height,
                                                                    jint fps,
                                                                    jint bitrate) {
    if (videoChannel) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_wish_videopath_Emotion_utils_LHelper_Livestart(JNIEnv *env, jobject thiz,
        jstring rtmpUrl) {
    //连接rtmp服务器
    if (isStart) {
    return;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_wish_videopath_Emotion_utils_LHelper_pushVideo(JNIEnv *env, jobject thiz,
        jbyteArray data_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_wish_videopath_Emotion_utils_LHelper_Livestop(JNIEnv *env, jobject thiz) {
    isStart = 0;//关闭rtmp
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_wish_videopath_Emotion_utils_LHelper_Liverelease(JNIEnv *env, jobject thiz) {
    if (videoChannel) {
        delete (videoChannel);
        videoChannel = nullptr;
    }
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_wish_videopath_Emotion_utils_LHelper_initAudioCodec(JNIEnv *env, jobject thiz,
                                                                   jint sample_rate,
                                                                   jint channel_count) {
    audioChannel = new AudioChannel;
    audioChannel->setCallBack(callBack);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_wish_videopath_Emotion_utils_LHelper_pushAudio(JNIEnv *env, jobject thiz,
                                                              jbyteArray buffer) {
    //没有实例化编码或者rtmp没连接成功时退出
    if (!audioChannel || !readyPushing) {
        return;
